...
// UniversityModel harvard =
// universityRepository.findBySlug("harvard").orElseThrow();
// UniversityModel oxford =
// universityRepository.findBySlug("oxford").orElseThrow();
//
//
// // ===============================
// // 2) FACULTIES
...
// }
//
// FacultyModel engineering = facultyRepository.findByName("Engineering
// Faculty").orElseThrow();
// FacultyModel business = facultyRepository.findByName("Business
// Faculty").orElseThrow();
//
//
// // ===============================
...
// }
//
// ProgramModel csProgram = programRepository.findByName("Computer Science
// MSc").orElseThrow();
// ProgramModel mbaProgram = programRepository.findByName("MBA Business
// Administration").orElseThrow();
//
//
// // ===============================
// // 4) SCHOLARSHIPS
